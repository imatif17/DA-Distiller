...
def main():
    ...
    testloader_target = DA_datasets.imageclef_test_loader(i, test_batch_size, 0)
    ...
    if teacher_pretrained_path != "":
        teacher_model.load_state_dict(torch.load(teacher_pretrained_path)['student_model'])
    ...
    od_kd_without_label(epochs, distiller_model, optimizer, train_loader_target,
                        testloader_target, device)
